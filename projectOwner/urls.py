...
from .views import CreateProjectView,MyProjectOffersView,FilteredOffersView,UpdateOfferStatusView
...
urlpatterns = [
    ...
    path('dashboard/', ProjectOwnerDashboardView.as_view(), name='projectowner-dashboard'),
