...
from .views import PendingUserDetailView, ApproveUserView, RejectUserView,NewUserDetailView
...
urlpatterns = [
    ...
    path('new-user-detail/<int:pk>/', NewUserDetailView.as_view(), name='new-user-detail')
